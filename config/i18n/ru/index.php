...
return array(
    ...
    "admin.setting.safeAccount"      => "Безопасность аккаунта и входа",
    "admin.setting.safeData"         => "Безопасность данных / безопасность передачи",
    "admin.setting.passwordErrorLock" => "Блокировка ввода пароля",
    "admin.setting.passwordErrorLockDesc" => "Пароль неверный в течение 5 раз подряд, и учетной записи не разрешается входить в систему в течение 30 секунд после блокировки. После открытия это может эффективно предотвратить взлом пароля путем перебора;",
    ...
    "admin.setting.loginIpCheck"     => "Белый список открытых IP",
    "admin.setting.loginIpCheckDesc" => "После открытия, только пользователи с указанным IP могут войти в систему, пожалуйста, будьте осторожны",
    "admin.setting.loginIpAllow"     => "Разрешенный IP",
    "admin.setting.loginIpAllowDesc" => "Заполните правила следующим образом (по умолчанию локальный IP-адрес сервера может быть IP-адресом локальной сети) <br/>
 Однострочный ip: совпадать, если равен <br/>
 Однострочный префикс ip: ip соответствует, если он начинается с префикса; <br/>
 интервал ip: два ips разделены пунктирной линией, ip соответствует этому интервалу; <br/>",
    ...
    "admin.setting.emailHostDesc"    => "Сервер почтовых ящиков, например smtp.163.com, порт можно настроить",
    ...
    "admin.setting.ifSaveCache"      => "Вам нужно войти снова после переключения, вы уверены, что хотите выполнить?",
    ...
    "admin.member.memberRemoveTips"  => "Каталог пользователя также будет удален после удаления, <br/> Вы уверены что хотите продолжить?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Ваш текущий IP не находится в белом списке разрешенных IP-адресов, пожалуйста, свяжитесь с администратором!",
    ...
    "admin.storage.ifDelStore"       => "Если в этом хранилище уже есть файлы, они будут перенесены в текущее хранилище по умолчанию. Продолжить?",
    ...
    "admin.storage.saveCorsTips"     => "Конфигурация корзины CORS не удалась, пожалуйста, следуйте документу [Помощь] для ручной настройки",
    ...
    "admin.backup.optionLocation"    => "Пожалуйста, сначала создайте хранилище, предназначенное для резервного копирования",
 ...
 post_max_size, нужно перезагрузить)",
    ...
    "common.version.menuTitle"       => "Лицензирование корпоративных продуктов",
    ...
    "common.version.tipsHistory"     => "Бесплатная версия поддерживает только 3 исторических версии, приобретите неограниченное количество лицензионных версий!",
    ...
    "common.copyright.formLogo"      => "Тип логотипа целевой страницы",
    ...
    "common.copyright.formLogoImage" => "Логотип целевой страницы",
    "common.copyright.formLogoImageDesc" => "Целевая страница и фоновый логотип управления, рекомендуемый размер 250x100, полупрозрачный формат PNG",
    ...
    "explorer.tag.addTo"             => "Добавить в тег",
    ...
    "user.isLoginTips"               => "Обнаружено, что вы в настоящее время вошли в систему!",
    ...
    "log-event-edit"                 => "Редактор обновил файл",
    "log-event-edit-item"            => "Редактор обновлен [1]",
    "log-event-edit-more"            => "Редактор обновил файл [1] раз",
    "log-event-edit-more-user"       => "Отредактировал и обновил файл [1] [2] раза",
    "log-event-edit-more-at"         => "Редактор обновил [1] файлов",
