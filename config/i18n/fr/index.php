...
return array(
    ...
    "admin.setting.safeAccount"      => "Sécurité de compte et de connexion",
    ...
    "admin.setting.passwordErrorLockDesc" => "Le mot de passe est incorrect pendant 5 fois consécutives et le compte n&#39;est pas autorisé à se connecter pendant 30 secondes après avoir été verrouillé. Après ouverture, il peut empêcher efficacement le craquage de mot de passe par force brute;",
    ...
    "admin.setting.loginIpCheck"     => "Liste blanche IP ouverte",
    "admin.setting.loginIpCheckDesc" => "Après ouverture, seuls les utilisateurs avec l&#39;IP spécifiée peuvent se connecter, veuillez faire attention",
    "admin.setting.loginIpAllow"     => "IP autorisée",
    "admin.setting.loginIpAllowDesc" => "Remplissez les règles comme suit (par défaut, l&#39;adresse IP locale du serveur est autorisée à être une adresse IP de réseau local): <br/>
 IP sur une seule ligne: correspond si égal <br/>
 Préfixe ip sur une seule ligne: ip correspond s&#39;il commence par un préfixe; <br/>
 intervalle ip: les deux ips sont divisés par une ligne pointillée; ip correspond à cet intervalle; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Vous devez vous reconnecter après le changement, êtes-vous sûr de vouloir exécuter?",
    ...
    "admin.member.memberRemoveTips"  => "Le répertoire des utilisateurs sera également supprimé après suppression, <br/> Es-tu sur de vouloir continuer?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Votre adresse IP actuelle ne figure pas dans la liste blanche des adresses IP autorisées, veuillez contacter l&#39;administrateur!",
    ...
    "admin.storage.saveCorsTips"     => "Échec de la configuration du bucket CORS, veuillez suivre le document [Aide] pour configurer manuellement",
    ...
    "admin.backup.optionLocation"    => "Veuillez d'abord créer un stockage dédié à la sauvegarde",
 ...
 post_max_size, besoin de redémarrer)",
    ...
    "common.version.menuTitle"       => "Licence de produit d&#39;entreprise",
    ...
    "common.copyright.formLogo"      => "Type de logo de page de destination",
    ...
    "common.copyright.formLogoImage" => "Image du logo de la page de destination",
    "common.copyright.formLogoImageDesc" => "Page de destination et logo d&#39;arrière-plan de gestion, taille recommandée 250 x 100, format png translucide",
    ...
    "explorer.tag.addTo"             => "Ajouter au tag",
    ...
    "user.isLoginTips"               => "Détecté que vous êtes actuellement connecté!",
    ...
    "log-event-edit"                 => "L&#39;éditeur a mis à jour le fichier",
    ...
    "log-event-edit-more-at"         => "Fichiers mis à jour par l&#39;éditeur [1]",
