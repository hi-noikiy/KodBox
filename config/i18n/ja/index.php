...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "パスワードが5回連続して正しくなく、アカウントがロックされた後、30秒間ログインすることが許可されていません。開封後、ブルートフォースパスワードのクラックを効果的に防止できます。",
    ...
    "admin.setting.loginIpCheck"     => "IPホワイトリストを開く",
    "admin.setting.loginIpCheckDesc" => "開いた後、指定されたIPを持つユーザーのみがログインできます。注意してください",
    "admin.setting.loginIpAllow"     => "許可されたIP",
    "admin.setting.loginIpAllowDesc" => "次のようにルールを入力します（デフォルトでは、サーバーのローカルIPはローカルエリアネットワークのIPにすることができます）。 <br/>
単一行IP：等しい場合に一致<br/>
単一行のIPプレフィックス：プレフィックスで始まる場合、IPは一致します。 <br/>
 ip間隔：2つのipは破線で分割され、ipはこの間隔で一致します。 <br/>",
    ...
    "admin.setting.emailHostDesc"    => "smtp.163.comなどのメールボックスサーバーのポートはカスタマイズ可能",
    ...
    "admin.setting.ifSaveCache"      => "切り替え後に再度ログインする必要があります。実行してもよろしいですか？",
    ...
    "admin.member.memberRemoveTips"  => "削除後、ユーザーディレクトリも削除されます。 <br/>続行してもよろしいですか？",
    ...
    "ERROR_IP_NOT_ALLOW"             => "現在のIPは許可されたIPのホワイトリストにありません。管理者に連絡してください！",
    ...
    "admin.storage.ifDelStore"       => "このストレージにすでにファイルがある場合、それらは現在のデフォルトストレージに移行されます。続行しますか？",
    ...
    "admin.storage.saveCorsTips"     => "バケットの設定CORSに失敗しました。[ヘルプ]ドキュメントに従って手動で設定してください",
    ...
    "admin.backup.optionLocation"    => "最初にバックアップ専用のストレージを作成してください",
 ...
 post_max_size、再起動が必要）",
    ...
    "common.version.menuTitle"       => "エンタープライズ製品のライセンス",
    ...
    "common.version.tipsHistory"     => "無料版は3つの履歴バージョンのみをサポートしています。無制限の数のライセンス版を購入してください！",
    ...
    "common.copyright.formLogo"      => "ランディングページのロゴタイプ",
    ...
    "common.copyright.formLogoImage" => "ランディングページのロゴ画像",
    "common.copyright.formLogoImageDesc" => "ランディングページと管理の背景ロゴ、推奨サイズ250x100、半透明のpng形式",
    ...
    "log-event-edit"                 => "エディターがファイルを更新した",
    "log-event-edit-item"            => "エディタが更新されました[1]",
    "log-event-edit-more"            => "エディターはファイルを[1]回更新しました",
    "log-event-edit-more-user"       => "ファイルを[1] [2]回編集および更新しました",
    "log-event-edit-more-at"         => "エディターが更新した[1]ファイル",
