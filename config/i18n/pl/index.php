...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Hasło jest niepoprawne 5 razy z rzędu, a konto nie może się logować przez 30 sekund po zablokowaniu. Po otwarciu może skutecznie zapobiec złamaniu hasła przez brutalną siłę;",
    ...
    "admin.setting.loginIpCheck"     => "Otwórz białą listę IP",
    "admin.setting.loginIpCheckDesc" => "Po otwarciu tylko użytkownicy z określonym adresem IP mogą się zalogować, należy zachować ostrożność",
    "admin.setting.loginIpAllow"     => "Dozwolone IP",
    "admin.setting.loginIpAllowDesc" => "Wypełnij reguły w następujący sposób (domyślnie lokalny adres IP serwera może być ip sieci lokalnej): <br/>
 Pojedyncza linia ip: dopasuj, jeśli jest równa <br/>
 Jednowierszowy prefiks ip: ip pasuje, jeśli zaczyna się od prefiksu; <br/>
 Interwał ip: dwa IP są podzielone linią przerywaną; ip odpowiada w tym interwale; <br/>",
    ...
    "admin.setting.emailHostDesc"    => "Serwer skrzynek pocztowych, taki jak smtp.163.com, można dostosować port",
    ...
    "admin.setting.ifSaveCache"      => "Musisz się zalogować ponownie po przełączeniu, czy na pewno chcesz wykonać?",
    ...
    "admin.member.memberRemoveTips"  => "Katalog użytkownika zostanie również usunięty po usunięciu, <br/> Jesteś pewien, że chcesz kontynuować?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Twój obecny adres IP nie znajduje się na białej liście dozwolonych adresów IP, skontaktuj się z administratorem!",
    ...
    "admin.storage.ifDelStore"       => "Jeśli w tym magazynie znajdują się już pliki, zostaną one przeniesione do bieżącego magazynu domyślnego. Czy chcesz kontynuować?",
    ...
    "admin.storage.saveCorsTips"     => "Konfiguracja zasobnika CORS nie powiodła się. Postępuj zgodnie z dokumentem [Pomoc], aby ręcznie skonfigurować",
    ...
    "admin.backup.optionLocation"    => "Najpierw utwórz miejsce przeznaczone na kopie zapasowe",
 ...
 post_max_size, trzeba zrestartować)",
    ...
    "common.version.menuTitle"       => "Licencjonowanie produktów dla przedsiębiorstw",
    ...
    "common.version.tipsHistory"     => "Darmowa wersja obsługuje tylko 3 wersje historyczne; kup nieograniczoną liczbę wersji licencjonowanych!",
    ...
    "common.copyright.formLogo"      => "Typ logo strony docelowej",
    ...
    "common.copyright.formLogoImage" => "Obraz logo strony docelowej",
    "common.copyright.formLogoImageDesc" => "Logo strony docelowej i tła zarządzania, zalecany rozmiar 250 x 100, przezroczysty format png",
    ...
    "explorer.tag.addTo"             => "Dodaj do tagu",
    ...
    "log-event-edit"                 => "Edytor zaktualizował plik",
    "log-event-edit-item"            => "Zaktualizowano edytor [1]",
    "log-event-edit-more"            => "Edytor zaktualizował plik [1] razy",
    "log-event-edit-more-user"       => "Edytował i aktualizował plik [1] [2] razy",
    "log-event-edit-more-at"         => "Edytor zaktualizował pliki [1]",
