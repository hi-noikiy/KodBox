...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "كلمة المرور غير صحيحة لمدة 5 مرات متتالية ، ولا يُسمح للحساب بتسجيل الدخول لمدة 30 ثانية بعد قفلها.",
    ...
    "admin.setting.loginIpCheck"     => "افتح القائمة البيضاء لعنوان IP",
    "admin.setting.loginIpCheckDesc" => "بعد الفتح ، يمكن فقط للمستخدمين الذين لديهم عنوان IP محدد تسجيل الدخول ، يرجى توخي الحذر",
    "admin.setting.loginIpAllow"     => "عنوان IP المسموح به",
    "admin.setting.loginIpAllowDesc" => "املأ القواعد كما يلي (بشكل افتراضي ، يُسمح لعنوان IP المحلي للخادم أن يكون عنوان IP لشبكة محلية): <br/>
 ip سطر واحد: تطابق إذا كان يساوي <br/>
 بادئة IP أحادية الخط: تتطابق ip إذا كانت تبدأ ببادئة ؛ <br/>
 فاصل ip: ينقسم ips بين اثنين من خط متقطع ؛ يطابق ip في هذا الفاصل ؛ <br/>",
    ...
    "admin.setting.ifSaveCache"      => "تحتاج إلى تسجيل الدخول مرة أخرى بعد التبديل ، هل أنت متأكد من أنك تريد التنفيذ؟",
    ...
    "admin.member.memberRemoveTips"  => "سيتم أيضًا حذف دليل المستخدم بعد الحذف ، <br/> هل أنت متأكد أنك تريد الاستمرار؟",
    ...
    "ERROR_IP_NOT_ALLOW"             => "عنوان IP الحالي الخاص بك ليس في القائمة البيضاء لعناوين IP المسموح بها ، يرجى الاتصال بالمسؤول!",
    ...
    "admin.storage.saveCorsTips"     => "فشل تكوين CORS للمجموعة ، يرجى اتباع مستند [Help] لتكوينه يدويًا",
    ...
    "admin.backup.optionLocation"    => "الرجاء إنشاء مساحة تخزين مخصصة للنسخ الاحتياطي أولاً",
 ...
 post_max_size ، تحتاج إلى إعادة التشغيل)",
    ...
    "common.version.menuTitle"       => "ترخيص منتجات المؤسسة",
    ...
    "common.copyright.formLogo"      => "نوع شعار الصفحة المقصودة",
    ...
    "common.copyright.formLogoImage" => "صورة شعار الصفحة المقصودة",
    "common.copyright.formLogoImageDesc" => "الصفحة المقصودة وشعار الخلفية الإدارية ، الحجم الموصى به 250x100 ، تنسيق png شفاف",
    ...
    "explorer.tag.addTo"             => "أضف إلى الوسم",
    ...
    "user.isLoginTips"               => "اكتشف أنك قمت بتسجيل الدخول حاليًا!",
    ...
    "log-event-edit"                 => "قام المحرر بتحديث الملف",
    ...
    "log-event-edit-more-at"         => "قام المحرر بتحديث [1] ملفات",
