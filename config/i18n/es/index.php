...
return array(
    ...
    "admin.setting.safeAccount"      => "Cuenta y seguridad de inicio de sesión",
    ...
    "admin.setting.passwordErrorLockDesc" => "La contraseña es incorrecta 5 veces consecutivas y la cuenta no puede iniciar sesión durante 30 segundos después de ser bloqueada.",
    ...
    "admin.setting.loginIpCheck"     => "Abrir la lista blanca de IP",
    "admin.setting.loginIpCheckDesc" => "Después de abrir, solo los usuarios con IP especificada pueden iniciar sesión, tenga cuidado",
    "admin.setting.loginIpAllow"     => "IP permitida",
    "admin.setting.loginIpAllowDesc" => "Complete las reglas de la siguiente manera (de forma predeterminada, la IP local del servidor puede ser una IP de red de área local): <br/>
 IP de línea única: coincide si es igual <br/>
 Prefijo de ip de una sola línea: coincide con ip si comienza con un prefijo; <br/>
 intervalo de ip: los dos ips se dividen por una línea discontinua; las coincidencias de ip en este intervalo; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Debe iniciar sesión nuevamente después de cambiar, ¿está seguro de que desea ejecutar?",
    ...
    "admin.member.memberRemoveTips"  => "El directorio de usuarios también se eliminará después de la eliminación, <br/> Estás seguro de que quieres continuar?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Su IP actual no está en la lista blanca de IP permitidas, ¡comuníquese con el administrador!",
    ...
    "admin.storage.saveCorsTips"     => "La configuración de la cuchara CORS falló, siga el documento [Ayuda] para configurar manualmente",
    ...
    "admin.backup.optionLocation"    => "Primero crea un almacenamiento dedicado a la copia de seguridad",
 ...
 post_max_size, necesita reiniciar)",
    ...
    "common.version.menuTitle"       => "Licencias de productos empresariales",
    ...
    "common.copyright.formLogo"      => "Tipo de logotipo de página de destino",
    ...
    "common.copyright.formLogoImage" => "Imagen del logotipo de la página de destino",
    "common.copyright.formLogoImageDesc" => "Página de destino y logotipo de fondo de gestión, tamaño recomendado 250x100, formato png translúcido",
    ...
    "explorer.tag.addTo"             => "Agregar a la etiqueta",
    ...
    "user.isLoginTips"               => "¡Detectado que estás conectado actualmente!",
    ...
    "log-event-edit"                 => "El editor actualizó el archivo",
    ...
    "log-event-edit-more-at"         => "Editor actualizado [1] archivos",
