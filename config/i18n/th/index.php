...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "รหัสผ่านไม่ถูกต้องเป็นเวลา 5 ครั้งติดต่อกันและบัญชีไม่ได้รับอนุญาตให้เข้าสู่ระบบเป็นเวลา 30 วินาทีหลังจากถูกล็อคหลังจากเปิดแล้วจะสามารถป้องกันการถอดรหัสด้วยรหัสผ่านที่รุนแรงได้อย่างมีประสิทธิภาพ",
    ...
    "admin.setting.loginIpCheck"     => "เปิดรายการที่อนุญาตของ IP",
    "admin.setting.loginIpCheckDesc" => "หลังจากเปิดแล้วผู้ใช้ที่มี IP ที่ระบุเท่านั้นที่สามารถเข้าสู่ระบบได้โปรดระวัง",
    "admin.setting.loginIpAllow"     => "IP ที่ได้รับอนุญาต",
    "admin.setting.loginIpAllowDesc" => "กรอกกฎดังนี้ (โดยค่าเริ่มต้น IP ท้องถิ่นของเซิร์ฟเวอร์ได้รับอนุญาตให้เป็น IP เครือข่ายท้องถิ่น): <br/>
 ip บรรทัดเดียว: จับคู่ถ้าเท่ากัน <br/>
 คำนำหน้า ip แบบบรรทัดเดียว: ip ตรงกันหากเริ่มต้นด้วยคำนำหน้า <br/>
 ip interval: สอง ips ถูกหารด้วยเส้นประการจับคู่ ip ในช่วงเวลานี้ <br/>",
    ...
    "admin.setting.emailHostDesc"    => "เซิร์ฟเวอร์กล่องจดหมายเช่น smtp.163.com สามารถปรับแต่งพอร์ตได้",
    ...
    "admin.setting.ifSaveCache"      => "คุณต้องเข้าสู่ระบบอีกครั้งหลังจากเปลี่ยนคุณแน่ใจหรือไม่ว่าต้องการดำเนินการ",
    ...
    "admin.member.memberRemoveTips"  => "ไดเรกทอรีผู้ใช้จะถูกลบหลังจากการลบ <br/> แน่ใจไหมว่าต้องการดำเนินการต่อ",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP ปัจจุบันของคุณไม่อยู่ในรายการสีขาวของ IP ที่อนุญาตโปรดติดต่อผู้ดูแลระบบ!",
    ...
    "admin.storage.ifDelStore"       => "หากมีไฟล์อยู่ในที่เก็บข้อมูลนี้ไฟล์เหล่านั้นจะถูกย้ายไปยังที่เก็บข้อมูลเริ่มต้นปัจจุบันคุณต้องการดำเนินการต่อหรือไม่",
    ...
    "admin.storage.saveCorsTips"     => "การกำหนดค่าที่เก็บข้อมูล CORS ล้มเหลวโปรดติดตามเอกสาร [วิธีใช้] เพื่อกำหนดค่าด้วยตนเอง",
    ...
    "admin.backup.optionLocation"    => "โปรดสร้างที่เก็บข้อมูลเฉพาะสำหรับการสำรองข้อมูลก่อน",
 ...
 post_max_size ต้องเริ่มต้นใหม่)",
    ...
    "common.version.menuTitle"       => "ใบอนุญาตผลิตภัณฑ์สำหรับองค์กร",
    ...
    "common.version.tipsHistory"     => "รุ่นฟรีรองรับเฉพาะรุ่น 3 รุ่นเท่านั้นซื้อรุ่นลิขสิทธิ์ได้ไม่ จำกัด จำนวน!",
    ...
    "common.copyright.formLogo"      => "ประเภทโลโก้หน้า Landing Page",
    ...
    "common.copyright.formLogoImage" => "รูปภาพโลโก้ของหน้า Landing Page",
    "common.copyright.formLogoImageDesc" => "โลโก้หน้า Landing Page และการจัดการพื้นหลังขนาดแนะนำ 250x100 รูปแบบ png โปร่งแสง",
    ...
    "explorer.tag.addTo"             => "เพิ่มในแท็ก",
    ...
    "user.isLoginTips"               => "ตรวจพบว่าคุณกำลังเข้าสู่ระบบในขณะนี้!",
    ...
    "log-event-edit"                 => "ตัวแก้ไขอัพเดตไฟล์",
    "log-event-edit-item"            => "แก้ไขการอัปเดต [1]",
    "log-event-edit-more"            => "เครื่องมือแก้ไขอัปเดตไฟล์ [1] ครั้ง",
    "log-event-edit-more-user"       => "แก้ไขและอัปเดตไฟล์ [1] [2] ครั้ง",
    "log-event-edit-more-at"         => "ตัวแก้ไขอัปเดต [1] ไฟล์",
