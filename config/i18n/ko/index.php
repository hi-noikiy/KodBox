...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "비밀번호는 5 회 연속 올바르지 않으며 계정을 잠근 후 30 초 동안 로그인 할 수 없습니다. 개설 후에는 무차별 암호 크래킹을 효과적으로 방지 할 수 있습니다.",
    ...
    "admin.setting.loginIpCheck"     => "개방형 IP 화이트리스트",
    "admin.setting.loginIpCheckDesc" => "개설 후에는 지정된 IP를 가진 사용자 만 로그인 할 수 있습니다.",
    "admin.setting.loginIpAllow"     => "허용 된 IP",
    "admin.setting.loginIpAllowDesc" => "다음과 같이 규칙을 작성하십시오 (기본적으로 서버의 로컬 IP는 LAN (Local Area Network) IP가 될 수 있습니다). <br/>
 단일 회선 IP : 동일하면 일치 <br/>
 단일 행 IP 접두사 : 접두사로 시작하면 ip가 일치합니다. <br/>
 ip 간격 : 두 개의 ip는 점선으로 나뉘며 ip는이 간격에서 일치합니다. <br/>",
    ...
    "admin.setting.emailHostDesc"    => "smtp.163.com과 같은 사서함 서버, 포트를 사용자 지정할 수 있습니다.",
    ...
    "admin.setting.ifSaveCache"      => "전환 후 다시 로그인해야합니다. 계속 하시겠습니까?",
    ...
    "admin.member.memberRemoveTips"  => "사용자 디렉토리도 삭제 후 삭제됩니다. <br/> 너 정말 계속하고 싶니?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "현재 IP가 허용 된 IP 목록에 없습니다. 관리자에게 문의하십시오!",
    ...
    "admin.storage.ifDelStore"       => "이 저장소에 파일이 이미 있으면 현재 기본 저장소로 마이그레이션됩니다. 계속 하시겠습니까?",
    ...
    "admin.storage.saveCorsTips"     => "버킷 구성 CORS가 실패했습니다. [도움말] 문서에 따라 수동으로 구성하십시오.",
    ...
    "admin.backup.optionLocation"    => "먼저 백업 전용 스토리지를 만드십시오.",
 ...
 post_max_size, 다시 시작해야 함)",
    ...
    "common.version.menuTitle"       => "엔터프라이즈 제품 라이센스",
    ...
    "common.version.tipsHistory"     => "무료 버전은 3 가지 이전 버전 만 지원합니다. 라이센스가 부여 된 버전을 무제한 구매하십시오!",
    ...
    "common.copyright.formLogo"      => "방문 페이지 로고 유형",
    ...
    "common.copyright.formLogoImage" => "방문 페이지 로고 이미지",
    "common.copyright.formLogoImageDesc" => "방문 페이지 및 관리 배경 로고, 권장 크기 250x100, 반투명 PNG 형식",
    ...
    "user.isLoginTips"               => "현재 로그인 한 것을 감지했습니다!",
    ...
    "log-event-edit"                 => "에디터가 파일을 업데이트했습니다",
    "log-event-edit-item"            => "에디터 업데이트 [1]",
    "log-event-edit-more"            => "에디터가 파일을 [1] 번 업데이트했습니다",
    "log-event-edit-more-user"       => "파일을 [1] [2] 번 편집하고 업데이트했습니다.",
    "log-event-edit-more-at"         => "편집기가 [1] 개 파일을 업데이트했습니다.",
