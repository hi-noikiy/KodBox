...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Mật khẩu không chính xác trong 5 lần liên tiếp và tài khoản không được phép đăng nhập trong 30 giây sau khi bị khóa. Sau khi mở, nó có thể ngăn chặn hiệu quả việc bẻ khóa mật khẩu vũ phu",
    ...
    "admin.setting.loginIpCheck"     => "Mở danh sách trắng IP",
    "admin.setting.loginIpCheckDesc" => "Sau khi mở, chỉ những người dùng có IP được chỉ định mới có thể đăng nhập, vui lòng cẩn thận",
    "admin.setting.loginIpAllow"     => "IP được phép",
    "admin.setting.loginIpAllowDesc" => "Điền vào các quy tắc như sau (theo mặc định, IP cục bộ của máy chủ được phép là ip mạng cục bộ): <br/>
 IP dòng đơn: khớp nếu bằng <br/>
 Tiền tố ip một dòng: ip khớp với nếu nó bắt đầu bằng một tiền tố; <br/>
 khoảng ip: Hai ips được chia cho một đường đứt nét; ip khớp trong khoảng này; <br/>",
    ...
    "admin.setting.emailHostDesc"    => "Máy chủ hộp thư, chẳng hạn như smtp.163.com, cổng có thể được tùy chỉnh",
    ...
    "admin.setting.ifSaveCache"      => "Bạn cần đăng nhập lại sau khi chuyển đổi, bạn có chắc chắn muốn thực hiện không?",
    ...
    "admin.member.memberRemoveTips"  => "Thư mục người dùng cũng sẽ bị xóa sau khi xóa, <br/> Bạn có chắc chắn muốn tiếp tục không?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP hiện tại của bạn không nằm trong danh sách trắng các IP được phép, vui lòng liên hệ với quản trị viên!",
    ...
    "admin.storage.ifDelStore"       => "Nếu đã có tệp trong bộ lưu trữ này, chúng sẽ được di chuyển sang bộ nhớ mặc định hiện tại. Bạn có muốn tiếp tục không?",
    ...
    "admin.storage.saveCorsTips"     => "Cấu hình nhóm CORS không thành công, vui lòng làm theo tài liệu [Trợ giúp] để định cấu hình thủ công",
    ...
    "admin.backup.optionLocation"    => "Trước tiên, hãy tạo một bộ nhớ dành riêng để sao lưu",
 ...
 post_max_size, cần khởi động lại)",
    ...
    "common.version.menuTitle"       => "Cấp phép sản phẩm doanh nghiệp",
    ...
    "common.version.tipsHistory"     => "Phiên bản miễn phí chỉ hỗ trợ 3 phiên bản lịch sử, mua số lượng phiên bản được cấp phép không giới hạn!",
    ...
    "common.copyright.formLogo"      => "Loại logo trang đích",
    ...
    "common.copyright.formLogoImage" => "Hình ảnh logo trang đích",
    "common.copyright.formLogoImageDesc" => "Trang đích và logo nền quản lý, kích thước được đề xuất 250x100, định dạng png mờ",
    ...
    "explorer.tag.addTo"             => "Thêm vào thẻ",
    ...
    "user.isLoginTips"               => "Đã phát hiện ra rằng bạn hiện đang đăng nhập!",
    ...
    "log-event-edit"                 => "Trình chỉnh sửa cập nhật tệp",
    "log-event-edit-item"            => "Trình chỉnh sửa được cập nhật [1]",
    "log-event-edit-more"            => "Trình chỉnh sửa đã cập nhật tệp [1] lần",
    "log-event-edit-more-user"       => "Đã chỉnh sửa và cập nhật tệp [1] [2] lần",
    "log-event-edit-more-at"         => "Trình chỉnh sửa được cập nhật [1] tệp",
