...
return array(
    ...
    "admin.setting.safeAccount"      => "Segurança da conta e login",
    ...
    "admin.setting.passwordErrorLockDesc" => "A senha está incorreta por 5 vezes consecutivas e a conta não tem permissão para fazer login por 30s após ser bloqueada. Após a abertura, ela pode efetivamente impedir a quebra de senha de força bruta;",
    ...
    "admin.setting.loginIpCheck"     => "Lista de permissões de IP aberto",
    "admin.setting.loginIpCheckDesc" => "Após a abertura, apenas usuários com IP especificado podem fazer login, tenha cuidado",
    "admin.setting.loginIpAllow"     => "IP permitido",
    "admin.setting.loginIpAllowDesc" => "Preencha as regras da seguinte maneira (por padrão, o IP local do servidor pode ser um IP da LAN) <br/>
 IP de linha única: corresponde se for igual <br/>
 Prefixo ip de linha única: ip corresponde se iniciar com um prefixo; <br/>
 intervalo ip: os dois ips são divididos por uma linha tracejada; o ip corresponde nesse intervalo; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Você precisa fazer login novamente após a troca. Tem certeza de que deseja executar?",
    ...
    "admin.member.memberRemoveTips"  => "O diretório do usuário também será excluído após a exclusão, <br/> Você tem certeza que quer continuar?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Seu IP atual não está na lista branca de IPs permitidos, entre em contato com o administrador!",
    ...
    "admin.storage.saveCorsTips"     => "Falha na configuração do balde CORS, siga o documento [Ajuda] para configurar manualmente",
    ...
    "admin.backup.optionLocation"    => "Por favor, crie um armazenamento dedicado ao backup primeiro",
 ...
 post_max_size, precisa reiniciar)",
    ...
    "common.version.menuTitle"       => "Licenciamento de produtos corporativos",
    ...
    "common.copyright.formLogo"      => "Tipo de logotipo da página de destino",
    ...
    "common.copyright.formLogoImage" => "Imagem do logotipo da página de destino",
    "common.copyright.formLogoImageDesc" => "Logotipo da página de destino e plano de fundo de gerenciamento, tamanho recomendado 250 x 100, formato png translúcido",
    ...
    "explorer.tag.addTo"             => "Adicionar à tag",
    ...
    "user.isLoginTips"               => "Detectou que você está conectado no momento!",
    ...
    "log-event-edit"                 => "O editor atualizou o arquivo",
    ...
    "log-event-edit-more-at"         => "Arquivos [1] atualizados pelo editor",
