...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "The password is incorrect for 5 consecutive times, and the account is not allowed to log in for 30s after being locked",
    "admin.setting.passwordRule"     => "User password strong",
    ...
    "admin.setting.loginIpCheck"     => "Open IP whitelist",
    "admin.setting.loginIpCheckDesc" => "After opening, only users with specified IP can log in, please be careful",
    "admin.setting.loginIpAllow"     => "Allowed IP",
    "admin.setting.loginIpAllowDesc" => "Fill in the rules as follows (by default, the server's local IP is allowed to be a LAN IP) <br/>
 Single line ip: match if equal <br/>
 Single-line ip prefix: ip matches if it starts with a prefix; <br/>
 ip interval: The two ips are divided by a dashed line; ip matches in this interval; <br/>",
    ...
    "admin.setting.groupRootListChild" => "Enterprise web disk lists sub-sectors",
    ...
    "admin.setting.ifSaveCache"      => "You need to log in again after switching, are you sure you want to execute?",
    ...
    "admin.group.setSizeBatch"       => "Set space size in batches",
    ...
    "admin.member.groupRemove"       => "Remove from department",
    ...
    "admin.member.memberRemoveTips"  => "The user directory will also be deleted after deletion, <br/> Are you sure you want to continue?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Your current IP is not in the white list of allowed IPs, please contact the administrator!",
    ...
    "admin.storage.saveCorsTips"     => "Bucket configuration CORS failed, please follow the [Help] document to manually configure",
    ...
    "admin.backup.optionLocation"    => "Please create a storage dedicated to backup first",
 ...
 post_max_size, need to restart)",
    ...
    "common.version.menuTitle"       => "Enterprise Product Licensing",
    ...
    "common.copyright.formLogo"      => "Landing page logo type",
    ...
    "common.copyright.formLogoImage" => "Landing page logo image",
    "common.copyright.formLogoImageDesc" => "Landing page and management background logo, recommended size 250x100, translucent png format",
    ...
    "common.copyright.contact"       => "By license please contact QQ: <a href=\"http://wpa.qq.com/msgrd?v=3&uin=3532208565&site=qq&menu=yes\" target=\"_blank\">3532208565</a> <a href=\"javascript:core.openWindow('http://bbs.kodcloud.com/');\">problem feedback</a>",
    ...
    "user.isLoginTips"               => "Detected that you are currently logged in!",
    ...
    "log-event-edit"                 => "The editor updated the file",
    ...
    "log-event-edit-more-at"         => "Editor updated [1] files",
    ...
    "log-event-share-shareEdit-item" => "Edited [1]&#39;s share",
