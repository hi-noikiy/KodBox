...
return array(
    ...
    "admin.setting.safeAccount"      => "Захист облікового запису та входу",
    "admin.setting.safeData"         => "Безпека даних / безпека передачі",
    "admin.setting.passwordErrorLock" => "Блокування помилки введення паролем",
    "admin.setting.passwordErrorLockDesc" => "Пароль невірний 5 разів поспіль, і обліковий запис заборонено входити протягом 30-х років після його блокування. Після відкриття він може ефективно запобігти злому пароля від грубої сили;",
    ...
    "admin.setting.loginIpCheck"     => "Відкрити білий список IP-адрес",
    "admin.setting.loginIpCheckDesc" => "Після відкриття можуть увійти лише користувачі із вказаним IP-адресою. Будьте уважні",
    "admin.setting.loginIpAllow"     => "Дозволений IP",
    "admin.setting.loginIpAllowDesc" => "Заповніть правила наступним чином (за замовчуванням локальним IP-сервером дозволено бути локальною мережею ip): <br/>
 Один рядок ip: збігається, якщо рівний <br/>
 Однорядковий префікс ip: ip відповідає, якщо він починається з префікса; <br/>
 інтервал ip: два ips розділені пунктирною лінією; ip збігається в цьому інтервалі; <br/>",
    ...
    "admin.setting.emailHostDesc"    => "Сервер поштової скриньки, наприклад smtp.163.com, порт може бути налаштований",
    ...
    "admin.setting.ifSaveCache"      => "Вам потрібно знову увійти після переключення. Ви впевнені, що хочете виконати?",
    ...
    "admin.member.memberRemoveTips"  => "Каталог користувачів також буде видалений після видалення, <br/> Ви впевнені, що хочете продовжити?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Ваш поточний IP-адреса відсутній у білому списку дозволених IP-адрес, зверніться до адміністратора!",
    ...
    "admin.storage.ifDelStore"       => "Якщо в цьому сховищі вже є файли, вони будуть переміщені до поточного сховища за замовчуванням. Ви хочете продовжити?",
    ...
    "admin.storage.saveCorsTips"     => "Конфігурація відра CORS не вдалася, будь ласка, дотримуйтесь документа [Довідка] для налаштування вручну",
    ...
    "admin.backup.optionLocation"    => "Спершу створіть сховище, призначене для резервного копіювання",
 ...
 post_max_size, потрібно перезапустити)",
    ...
    "common.version.menuTitle"       => "Ліцензування корпоративних продуктів",
    ...
    "common.version.tipsHistory"     => "Безкоштовна версія підтримує лише 3 історичні версії; купуйте необмежену кількість ліцензованих версій!",
    ...
    "common.copyright.formLogo"      => "Тип логотипу цільової сторінки",
    ...
    "common.copyright.formLogoImage" => "Зображення логотипу цільової сторінки",
    "common.copyright.formLogoImageDesc" => "Логотип цільової сторінки та фонового режиму управління, рекомендований розмір 250x100, напівпрозорий формат png",
    ...
    "explorer.tag.addTo"             => "Додати в тег",
    ...
    "user.isLoginTips"               => "Виявлено, що ви ввійшли в систему!",
    ...
    "log-event-edit"                 => "Редактор оновив файл",
    "log-event-edit-item"            => "Оновлений редактор [1]",
    "log-event-edit-more"            => "Редактор оновлював файл [1] разів",
    "log-event-edit-more-user"       => "Відредаговано та оновлено файл [1] [2] рази",
    "log-event-edit-more-at"         => "Редактор оновив [1] файли",
