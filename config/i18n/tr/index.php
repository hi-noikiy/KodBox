...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Şifre arka arkaya 5 kez yanlıştır ve hesabın kilitlendikten sonra 30 saniye boyunca oturum açmasına izin verilmez.Açıldıktan sonra kaba kuvvet şifre kırılmasını etkili bir şekilde önleyebilir",
    ...
    "admin.setting.loginIpCheck"     => "IP beyaz listesini aç",
    "admin.setting.loginIpCheckDesc" => "Açtıktan sonra, yalnızca belirtilen IP&#39;ye sahip kullanıcılar giriş yapabilir, lütfen dikkatli olun",
    "admin.setting.loginIpAllow"     => "İzin verilen IP",
    "admin.setting.loginIpAllowDesc" => "Kuralları aşağıdaki gibi doldurun (varsayılan olarak, sunucunun yerel IP&#39;sinin yerel alan ağı ip olmasına izin verilir): <br/>
 Tek satırlı ip: eşitse eşleştir <br/>
 Tek satırlı ip öneki: ip, bir önekle başlıyorsa eşleşir; <br/>
 ip aralığı: İki ips kesikli bir çizgiye bölünür; ip bu aralıkta eşleşir; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Geçiş yaptıktan sonra tekrar oturum açmanız gerekiyor, yürütmek istediğinizden emin misiniz?",
    ...
    "admin.member.memberRemoveTips"  => "Kullanıcı dizini de silindikten sonra silinecektir, <br/> Devam etmek istediğine emin misin?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Mevcut IP&#39;niz, izin verilen IP&#39;lerin beyaz listesinde değil, lütfen yöneticiye başvurun!",
    ...
    "admin.storage.saveCorsTips"     => "Grup yapılandırması CORS başarısız oldu, lütfen manuel olarak yapılandırmak için [Yardım] belgesini izleyin",
    ...
    "admin.backup.optionLocation"    => "Lütfen önce yedeklemeye ayrılmış bir depolama alanı oluşturun",
 ...
 post_max_size, yeniden başlatmanız gerekiyor)",
    ...
    "common.version.menuTitle"       => "Kurumsal Ürün Lisanslama",
    ...
    "common.copyright.formLogo"      => "Açılış sayfası logo türü",
    ...
    "common.copyright.formLogoImage" => "Açılış sayfası logo resmi",
    "common.copyright.formLogoImageDesc" => "Açılış sayfası ve yönetim arka plan logosu, önerilen boyut 250x100, yarı saydam png biçimi",
    ...
    "explorer.tag.addTo"             => "Etikete ekle",
    ...
    "log-event-edit"                 => "Editör dosyayı güncelledi",
    ...
    "log-event-edit-more-at"         => "Editör güncellenmiş [1] dosya",
