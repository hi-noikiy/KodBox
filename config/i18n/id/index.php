...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Kata sandi salah selama 5 kali berturut-turut, dan akun tidak diperbolehkan masuk selama 30-an setelah dikunci. Setelah dibuka, kata sandi ini dapat secara efektif mencegah pemecahan kata sandi brute force",
    ...
    "admin.setting.loginIpCheck"     => "Buka daftar putih IP",
    "admin.setting.loginIpCheckDesc" => "Setelah dibuka, hanya pengguna dengan IP tertentu yang bisa masuk, harap berhati-hati",
    "admin.setting.loginIpAllow"     => "IP yang diizinkan",
    "admin.setting.loginIpAllowDesc" => "Isi aturan sebagai berikut (secara default, IP lokal dari server diizinkan menjadi ip jaringan area lokal): <br/>
 IP baris tunggal: cocok jika sama <br/>
 Awalan ip baris tunggal: ip cocok jika diawali dengan awalan; <br/>
 ip interval: Dua ips dibagi dengan garis putus-putus; ip cocok dalam interval ini; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Anda harus masuk lagi setelah berpindah, Anda yakin ingin menjalankan?",
    ...
    "admin.member.memberRemoveTips"  => "Direktori pengguna juga akan dihapus setelah penghapusan, <br/> Apakah anda yakin ingin melanjutkan?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP Anda saat ini tidak ada dalam daftar putih IP yang diizinkan, silakan hubungi administrator!",
    ...
    "admin.storage.saveCorsTips"     => "Konfigurasi ember CORS gagal, harap ikuti dokumen [Help] untuk mengonfigurasi secara manual",
 ...
 post_max_size, perlu memulai ulang)",
    ...
    "common.version.menuTitle"       => "Lisensi Produk Perusahaan",
    ...
    "common.copyright.formLogo"      => "Jenis logo halaman arahan",
    ...
    "common.copyright.formLogoImage" => "Gambar logo halaman arahan",
    "common.copyright.formLogoImageDesc" => "Halaman arahan dan logo latar belakang manajemen, ukuran yang disarankan 250x100, format png transparan",
    ...
    "log-event-edit"                 => "Editor memperbarui file",
    ...
    "log-event-edit-more-at"         => "Editor memperbarui file [1]",
