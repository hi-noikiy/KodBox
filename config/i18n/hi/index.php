...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "पासवर्ड लगातार 5 बार गलत है, और लॉक होने के बाद खाते को 30 के लिए लॉग इन करने की अनुमति नहीं है। खोलने के बाद, यह प्रभावी रूप से ब्रूट फोर्स पासवर्ड क्रैकिंग को रोक सकता है;",
    ...
    "admin.setting.loginIpCheck"     => "IP श्वेतसूची खोलें",
    "admin.setting.loginIpCheckDesc" => "खोलने के बाद, केवल निर्दिष्ट आईपी वाले उपयोगकर्ता लॉग इन कर सकते हैं, कृपया सावधान रहें",
    "admin.setting.loginIpAllow"     => "अनुमत आईपी",
    "admin.setting.loginIpAllowDesc" => "नियमों को निम्नानुसार भरें (डिफ़ॉल्ट रूप से, सर्वर के स्थानीय आईपी को लैन आईपी होने की अनुमति है) <br/>
 सिंगल लाइन आईपी: मैच अगर बराबर <br/>
 एकल-पंक्ति आईपी उपसर्ग: यदि यह उपसर्ग के साथ शुरू होता है तो आईपी मेल करता है; <br/>
 आईपी अंतराल: दो ips एक धराशायी रेखा से विभाजित होते हैं, इस अंतराल में आईपी मैच; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "आपको स्विच करने के बाद फिर से लॉग इन करने की आवश्यकता है, क्या आप वाकई निष्पादित करना चाहते हैं?",
    ...
    "admin.member.memberRemoveTips"  => "उपयोगकर्ता निर्देशिका को हटाने के बाद भी हटा दिया जाएगा, <br/> क्या तुम वाकई जारी रखना चाहते हो?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "आपका वर्तमान IP अनुमत IP की सफेद सूची में नहीं है, कृपया व्यवस्थापक से संपर्क करें!",
    ...
    "admin.storage.saveCorsTips"     => "बाल्टी कॉन्फ़िगरेशन CORS विफल, कृपया मैन्युअल रूप से कॉन्फ़िगर करने के लिए [सहायता] दस्तावेज़ का पालन करें",
 ...
 post_max_size, पुनरारंभ करने की आवश्यकता है)",
    ...
    "common.version.menuTitle"       => "एंटरप्राइज़ उत्पाद लाइसेंसिंग",
    ...
    "common.copyright.formLogo"      => "लैंडिंग पृष्ठ लोगो प्रकार",
    ...
    "common.copyright.formLogoImage" => "लैंडिंग पृष्ठ लोगो छवि",
    "common.copyright.formLogoImageDesc" => "लैंडिंग पृष्ठ और प्रबंधन पृष्ठभूमि लोगो, अनुशंसित आकार 250x100, पारभासी पीएनजी प्रारूप",
    ...
    "user.isLoginTips"               => "पता चला कि आप वर्तमान में लॉग इन हैं!",
    ...
    "log-event-edit"                 => "संपादक ने फाइल अपडेट की",
    ...
    "log-event-edit-more-at"         => "संपादक ने अपडेट किया [1] फाइलें",
