...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Das Passwort ist 5 Mal hintereinander falsch, und das Konto darf sich nach dem Sperren 30 Sekunden lang nicht anmelden. Nach dem Öffnen kann das Knacken von Brute-Force-Passwörtern wirksam verhindert werden.",
    ...
    "admin.setting.loginIpCheck"     => "Öffnen Sie die IP-Whitelist",
    "admin.setting.loginIpCheckDesc" => "Nach dem Öffnen können sich nur Benutzer mit der angegebenen IP-Adresse anmelden. Seien Sie bitte vorsichtig",
    "admin.setting.loginIpAllow"     => "Zulässige IP",
    "admin.setting.loginIpAllowDesc" => "Füllen Sie die Regeln wie folgt aus (standardmäßig darf die lokale IP des Servers eine lokale Netzwerk-IP sein): <br/>
 Einzeilige IP: Übereinstimmung, wenn gleich <br/>
 Einzeiliges IP-Präfix: IP stimmt überein, wenn es mit einem Präfix beginnt. <br/>
 IP-Intervall: Die beiden IP-Werte werden durch eine gestrichelte Linie geteilt. IP-Übereinstimmungen in diesem Intervall. <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Sie müssen sich nach dem Wechsel erneut anmelden. Sind Sie sicher, dass Sie ausführen möchten?",
    ...
    "admin.member.memberRemoveTips"  => "Das Benutzerverzeichnis wird auch nach dem Löschen gelöscht. <br/> Sind Sie sicher, dass Sie fortfahren möchten?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Ihre aktuelle IP ist nicht in der weißen Liste der zulässigen IPs enthalten. Bitte wenden Sie sich an den Administrator!",
    ...
    "admin.storage.saveCorsTips"     => "Bucket-Konfiguration CORS fehlgeschlagen. Befolgen Sie zur manuellen Konfiguration das Dokument [Hilfe]",
 ...
 post_max_size, muss neu gestartet werden)",
    ...
    "common.copyright.formLogo"      => "Landingpage-Logotyp",
    ...
    "common.copyright.formLogoImage" => "Landingpage-Logo-Bild",
    "common.copyright.formLogoImageDesc" => "Landingpage und Management-Hintergrundlogo, empfohlene Größe 250x100, durchscheinendes PNG-Format",
    ...
    "user.isLoginTips"               => "Es wurde festgestellt, dass Sie gerade angemeldet sind!",
    ...
    "log-event-edit"                 => "Der Editor hat die Datei aktualisiert",
    ...
    "log-event-edit-more-at"         => "Editor aktualisiert [1] Dateien",
