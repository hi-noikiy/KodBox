...
return array(
    ...
    "admin.setting.safeAccount"      => "账号及登陆安全",
    "admin.setting.safeData"         => "数据安全/传输安全",
    "admin.setting.passwordErrorLock" => "密码输入错误锁定",
    "admin.setting.passwordErrorLockDesc" => "连续5次密码错误,锁定该账户30s不允许登陆,开启后能有效防止密码暴力破解;",
    ...
    "admin.setting.loginIpCheck"     => "开启IP白名单",
    "admin.setting.loginIpCheckDesc" => "开启后,只允许指定ip的用户才能登陆,请谨慎操作",
    "admin.setting.loginIpAllow"     => "允许的IP",
    "admin.setting.loginIpAllowDesc" => "填写规则如下(默认允许服务器本机ip一级局域网ip):<br/>单行为ip: 相等则匹配<br/>单行为ip前缀: ip以前缀为开头则匹配;<br/>ip区间: 两个ip以中划线进行分割; ip在该区间内则匹配;<br/>",
    ...
    "admin.setting.ifSaveCache"      => "切换后需要重新登录，确定要执行吗？",
    ...
    "admin.member.memberRemoveTips"  => "删除后用户目录也会被删除<br/>确定要继续吗？",
    ...
    "ERROR_IP_NOT_ALLOW"             => "您当前ip不在允许登陆的ip白名单里,请联系管理员!",
    ...
    "admin.storage.saveCorsTips"     => "Bucket配置CORS失败，请按【使用帮助】文档进行手动配置",
    ...
    "admin.backup.optionLocation"    => "请先创建一个专门用于备份的存储",
...
post_max_size,需要重启)",
    ...
    "common.version.menuTitle"       => "企业产品授权",
    ...
    "common.copyright.formLogo"      => "登陆页logo类型",
    ...
    "common.copyright.formLogoImage" => "登陆页面logo图片",
    "common.copyright.formLogoImageDesc" => "登陆页面和管理后台logo,推荐尺寸250x100,半透明png格式",
