...
return array(
    ...
    "admin.setting.safeAccount"      => "Sicurezza dell&#39;account e dell&#39;accesso",
    ...
    "admin.setting.passwordErrorLockDesc" => "La password non è corretta per 5 volte consecutive e l&#39;account non è autorizzato ad accedere per 30 secondi dopo essere stato bloccato. Dopo l&#39;apertura, può effettivamente prevenire il cracking della password della forza bruta",
    ...
    "admin.setting.loginIpCheck"     => "Apri whitelist IP",
    "admin.setting.loginIpCheckDesc" => "Dopo l&#39;apertura, solo gli utenti con IP specificato possono accedere, si prega di fare attenzione",
    "admin.setting.loginIpAllow"     => "IP consentito",
    "admin.setting.loginIpAllowDesc" => "Compilare le regole come segue (per impostazione predefinita, l&#39;IP locale del server può essere un IP di rete locale): <br/>
 IP a linea singola: corrisponde se uguale <br/>
 Prefisso IP a riga singola: ip corrisponde se inizia con un prefisso; <br/>
 intervallo ip: i due ips sono divisi da una linea tratteggiata; ip corrisponde in questo intervallo; <br/>",
    ...
    "admin.setting.ifSaveCache"      => "Devi accedere di nuovo dopo il passaggio, sei sicuro di voler eseguire?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Il tuo IP attuale non è nella lista bianca degli IP consentiti, contatta l&#39;amministratore!",
    ...
    "admin.storage.defaultDesc"      => "L&#39;elemento predefinito è l&#39;unico metodo di archiviazione valido. Se si seleziona Sì, gli altri metodi di archiviazione predefiniti verranno automaticamente annullati. Procedere con cautela.",
    ...
    "admin.storage.saveCorsTips"     => "Configurazione benna CORS non riuscita, seguire il documento [Guida] per configurare manualmente",
    "admin.storage.saveError"        => "Impossibile connettersi all&#39;archivio specificato, verificare che le informazioni di configurazione siano corrette",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "common.version.name2"           => "Edizione professionale",
    "common.version.name3"           => "Edizione Enterprise",
    "common.version.name4"           => "Edizione avanzata 1",
    ...
    "common.version.vip4"            => "VIP 4 (Edizione Premium)",
    "common.version.vip5"            => "VIP 5 (Edizione Premium)",
    "common.version.vip6"            => "VIP 6 (Edizione Premium)",
    ...
    "common.version.menuTitle"       => "Licenze per prodotti aziendali",
    ...
    "common.copyright.formLogo"      => "Tipo di logo della pagina di destinazione",
    ...
    "common.copyright.formLogoImage" => "Immagine del logo della pagina di destinazione",
    "common.copyright.formLogoImageDesc" => "Pagina di destinazione e logo di sfondo di gestione, dimensioni consigliate 250x100, formato png traslucido",
    ...
    "explorer.toolbar.shareToMe"     => "Condividi con me",
    ...
    "explorer.app.openWindow"        => "Si apre una nuova finestra",
    "explorer.app.openDialog"        => "Si apre la finestra di dialogo",
    "explorer.app.openCurrent"       => "Si apre la pagina corrente",
    "explorer.app.openInline"        => "Si apre la pagina di incorporamento",
    ...
    "explorer.search.size100"        => "100 MB o più",
    ...
    "explorer.search.byUserDesc"     => "Ricerca per creatore, valida solo per il disco di rete del dipartimento.",
    ...
    "explorer.share.innerTo"         => "Condivisione della collaborazione interna",
    ...
    "explorer.share.cancelAuthDesc"  => "Sei sicuro di voler annullare questa condivisione? <br/> Se si tratta di condivisione collaborativa, l&#39;altra parte non può più vedere la tua condivisione e anche la condivisione a catena esterna aperta non sarà valida!",
    ...
    "user.isLoginTips"               => "Rilevato che sei attualmente connesso!",
    ...
    "user.nameHolder"                => "Numero di cellulare / e-mail, utilizzato per accedere e recuperare la password",
    ...
    "user.bindWxConfigError"         => "Le informazioni di configurazione di WeChat sono anomale, contattare l&#39;amministratore",
    ...
    "log-event-edit"                 => "L&#39;editor ha aggiornato il file",
    ...
    "log-event-edit-more-at"         => "Editor ha aggiornato i file [1]",
